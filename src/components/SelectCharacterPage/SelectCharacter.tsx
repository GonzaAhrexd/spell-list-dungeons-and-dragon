  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="character-selection">
        ...
        <div className={`flex item-center justify-center mt-2 font-bold text-2xl group p-4 border rounded-lg shadow-md cursor-pointer transition-transform transform hover:scale-105`} onClick={() => showGameMaster()}>
          Game Master
        </div>
        {openGroup === grupo && (
          <div className="mt-2">
